...
class tdb_header_menu_tdcwn_yr extends td_block {
    ...
    function render($atts, $content = null) {
        ...
        if ( td_global::get_in_menu() && ( td_util::tdc_is_live_editor_iframe() || td_util::tdc_is_live_editor_ajax() ) ) {
            ...
            $buffy .= '<div class="tdb_header_mega_menu ' . $this->get_block_classes()  . ' tdb-header-align" ' . $this->get_block_html_atts() . ' style=" z-index: 999;">';
...
//        }
        ...
        $buffy .= '<div class="tdb_header_menu ' . $this->get_block_classes( $additional_classes )  . ' tdb-header-align" ' . $this->get_block_html_atts() . ' style=" z-index: 999;">';
