...
class tds_my_account_yr extends td_block {
...
// Output the new array
        ...
        $buffy = '<div class="tds-page-block ' . ( empty($show_validation) ? '' : ' tds-invalid-account ' )  . $block_classes . ' tds_my_account ' . $this->get_block_html_atts() . '>';
